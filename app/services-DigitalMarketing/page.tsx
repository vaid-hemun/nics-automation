...
const digitalMarketingFaqData = [
  ...
  {
    id: 3,
    question: 'Why choose Digiwebclub for the Best Digital Marketing Services?',
    answer: 'Digiwebclub offers proven expertise, tailored solutions, global reach with a local touch, commitment to results, award-winning experience, and dedicated support for your digital marketing needs.'
  },
  {
    id: 4,
        ...
        <>
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="mb-4">However, it is a fantastic time for them to do so. We, at Digiwebclub, help businesses convert their current business models to online ones or incorporate digital marketing strategies into their current marketing plans. Brick-and-mortar companies now have a whole new range of opportunities. It helps them to grow their customer base in both existing and emerging markets.</p>
                    ...
                    <ul className="list-disc pl-6 mb-6">
                        ...
                        <li className="mb-2"><span className="font-semibold">Award-Winning Experience:</span> We at Digiwebclub have offered several leading businesses as well as entrepreneurs. We understand that digital marketing services are crucial to boost sales for your brands. You can attract potential buyers for your brands. Thus, we aim to offer exceptional services every time you approach us. We are renewed for the best-in-class digital marketing services. There is more to digital marketing than just visually appealing ads and social media posts. In the digital age, it all comes down to building genuine relationships with your customers. We also help in expanding your business in a sustainable manner. We have been awarded many times for our exceptional approach to digital marketing.</li>
                        <li className="mb-2"><span className="font-semibold">Dedicated Support:</span> Today, working with a digital marketing company is a must, not a choice. Getting unmatched excellence in digital marketing is possible. Choose services with a digital marketing company like Digiwebclub. If you want to reach a certain demographic, rank better in search engine results. Digital marketing helps you to produce much-needed leads and be seen and heard on the internet!</li>
                    </ul>
                </div>
            </section>
